  ...
  sections: [
    {
      ...
      images: [a("future report.mp4", "Future report", 1920, 1080, "full")],
    },
    {
      id: "water-infrastructure",
      pillLabel: "water infrastructure",
      groupBreak: true,
      images: [a("water infrastrucutre.png", "Water infrastructure", 1500, 3074, "full")],
    },
    {
    ...
    },
    {
      ...
      images: [a("masterplan.png", "Masterplan", 4961, 7016, "full")],
    },
    {
      id: "dam",
      pillLabel: "dam",
      groupBreak: true,
      images: [a("dam.gif", "Dam", 553, 737)],
    },
    {
    ...
    },
    {
      ...
      images: [
        a("4WD on thte field 1.png", "4WD on the field 1", 4961, 7016, "full"),
        a("4WD on thte field 2.png", "4WD on the field 2", 4961, 7016, "full"),
      ],
    },
    {
      id: "4wd-in-motion",
      ...
      images: [
        a("4WD in motion 1.gif", "4WD in motion 1", 516, 688),
        a("4WD in motion 2.png", "4WD in motion 2", 2076, 2768),
      ],
    },
    {
      id: "ranger-station",
      ...
      groupBreak: true,
      images: [
        a("ranger station 1.png", "Ranger station 1", 4961, 7016, "full"),
        a("ranger station 2.png", "Ranger station 2", 4961, 7016, "full"),
      ],
    },
    {
      ...
      images: [
        a("station to wetland 1.gif", "Station to wetland 1", 553, 737),
        a("station to wetland 2.gif", "Station to wetland 2", 497, 662),
      ],
    },
    {
      ...
      images: [
        a("water treatment plant 1.png", "Water treatment plant 1", 4961, 7016, "full"),
        a("water treatment plant 2.png", "Water treatment plant 2", 4961, 7016, "full"),
      ],
    },
    {
      ...
      images: [
        a("sewage canal to pool 1.gif", "Sewage canal to pool 1", 737, 983),
        a("sewage canal to pool 2.gif", "Sewage canal to pool 2", 504, 672),
      ],
    },
  ],
};
